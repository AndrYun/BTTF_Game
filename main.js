...
const car = new Delorian(
    ...
    rotation = 0,
    imageSrc = '/img/DeLorian_small-Sheet.png',
    health = 100,
    frameX = 0,
);
...
const shot = new Shoot(
    ...
    imageSrc = '/img/Blast_shot.png',
);

// blusterway 
const blusterway = new Blusterway(
    imageSrc = '/img/blusterway-Sheet.png', 
    position = {
        x: `${car.position.x - 32}`,
        y: `${car.position.y + 8}`,
    }, 
...
const blackhole = new BlackHole(
    imageSrc = '/img/BlackHole-Sheet.png', 
    position = {
...
const pepsiCan = new Pepsi(
    imageSrc = '/img/SpritePepsi_explose-Sheet.png',
    position = {
        x: getRandom(350, 400),
        y: getRandom(250, 300),
    },
...
const asteroid = new Asteroid(
    imageSrc = '/img/Asteroid-Sheet.png',
    position = {
        x: getRandom(250, 300),
        y: getRandom(-50, 0),
    },
